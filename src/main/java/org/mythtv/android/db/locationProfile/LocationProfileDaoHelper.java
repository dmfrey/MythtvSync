...
//		Log.d( TAG, "findAllHomeLocationProfiles : enter" );
        ...
        List<LocationProfile> profiles = findAllByType( context, LocationProfile.LocationType.HOME );
...
//		Log.d( TAG, "findAllAwayLocationProfiles : enter" );
        ...
        List<LocationProfile> profiles = findAllByType( context, LocationProfile.LocationType.AWAY );
...
//		Log.d( TAG, "setSelectedLocationProfile : exit" );
     ...
     * @return
     */
    public LocationProfile findByLocationTypeAndUrl( Context context, LocationProfile.LocationType type, String url ) {
...
//		Log.d( TAG, "findHomeProfileByUrl : enter" );
        ...
        LocationProfile profile = findByLocationTypeAndUrl( context, LocationProfile.LocationType.HOME, url );
...
//		Log.d( TAG, "findAwayProfileByUrl : enter" );
        ...
        LocationProfile profile = findByLocationTypeAndUrl( context, LocationProfile.LocationType.AWAY, url );
...
//		Log.d( TAG, "findSelectedHomeProfile : enter" );
        ...
        LocationProfile profile = findSelectedProfile( context, LocationProfile.LocationType.HOME );
...
//		Log.d( TAG, "findSelectedAwayProfile : enter" );
        ...
        LocationProfile profile = findSelectedProfile( context, LocationProfile.LocationType.AWAY );
...
//		Log.v( TAG, "convertCursorToLocationProfile : enter" );
        ...
        profile.setId( id );
        profile.setType( LocationProfile.LocationType.valueOf(type) );
...
//		Log.v( TAG, "convertCursorToLocationProfile : exit" );
    ...
    private List<LocationProfile> findAllByType( Context context, LocationProfile.LocationType type ) {
...
//		Log.d( TAG, "findAllByType : exit" );
    ...
    private LocationProfile findSelectedProfile( Context context, LocationProfile.LocationType type ) {
...
//		Log.d( TAG, "findSelectedProfile : exit" );
    ...
    private boolean resetSelectedProfiles( Context context, LocationProfile.LocationType type ) {
